...
config :graphical, GraphicalWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "BlXgUYTNXK56brNvWSLTkrUnwP4xaLSderv/SmARm/7YgwNg+erwtLaenF6bGCxN",
...
config :graphical, Graphical.Guardian,
  issuer: "graphical",
  secret_key: "B+k8v+dNhkRrNyu5QsGUheT/MGIvfQvrwbcgz5RWbIsn6ze3GGPisLyfWQbvXGoB"
